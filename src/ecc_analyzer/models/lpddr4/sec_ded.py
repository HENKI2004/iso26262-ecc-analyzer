            ...
            [
                ...
                PipelineBlock(
                    ...
                    [
                        ...
                        CoverageBlock("Inline_ECC_TBE", FaultType.TBE, self.tbe_dc, 0.0),
                    ],
                ),
                CoverageBlock("Inline_ECC_SBE", FaultType.SBE, self.sbe_dc, 0.0),
                CoverageBlock("Inline_ECC_DBE", FaultType.DBE, self.dbe_dc, 0.0),
