            ...
            [
                ...
                PipelineBlock(
                    ...
                    [
                        ...
                        CoverageBlock("sec_dec", FaultType.TBE, self.tbe_dc, self.tbe_dc),
                    ],
                ),
                CoverageBlock("sec_dec", FaultType.SBE, self.sbe_dc, self.sbe_dc),
                CoverageBlock("sec_dec", FaultType.DBE, self.dbe_dc, self.dbe_dc),
