            ...
            [
                ...
                PipelineBlock(
                    ...
                    [
                        ...
                        CoverageBlock("Inline_ECC_TBE", FaultType.TBE, self.tbe_dc, self.tbe_dc),
                    ],
                ),
                CoverageBlock("Inline_ECC_SBE", FaultType.SBE, self.sbe_dc, self.sbe_dc),
                CoverageBlock("Inline_ECC_DBE", FaultType.DBE, self.dbe_dc, self.dbe_dc),
                CoverageBlock("Inline_ECC_MBE", FaultType.MBE, self.mbe_dc, self.mbe_dc),
            ],
        )
